...
def test_config() -> None:
    ...
    check(bool(installer_version) and APP_VERSION == installer_version and APP_VERSION == "1.4.3",
          "viditelná verze aplikace odpovídá instalátoru 1.4.3")
...
def test_user_manuals() -> None:
    ...
    expected = {
        "QwenHarness-Manual-EN.pdf": (
            15, ("1.4.3", "Python 3.12", "Offline backup", "Work Modes",
                 "User-Facing Tool Reference", "Troubleshooting")),
        "QwenHarness-Manual-CS.pdf": (
            10, ("1.4.3", "Python 3.12", "offline zálohy", "Pracovní režimy",
